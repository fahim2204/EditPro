...
const PhotoColorize = () => {
  ...
  const sendApiRequest = (formUpData) => {
    axios.post("https://www.cutout.pro/api/v1/matting?mattingType=19", formUpData, {
      headers: {
  ...
  return (
    <>
      <Head>
        <title>Edit Pro - Photo Colorize</title>
      </Head>

      <MainLayout>
        <main className="portfolio-page style-1">
          <div className='portfolio-projects style-1 py-5'>
            <h1 className='text-center fs-2 mb-5'>Photo Colorize</h1>
