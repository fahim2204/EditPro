            ...
            <div className="p-6 bg-white md:flex-1">
              ...
              >
                ...
                <div>
                  <button
                    type="submit"
                    className="mt-3 w-full px-4 py-2 text-lg font-semibold text-white transition-colors duration-300 bg-dodger-blue-600 rounded-md shadow hover:bg-dodger-blue-700 focus:outline-none focus:ring-blue-200 focus:ring-4"
                  >
                    Register
                  </button>
                </div>
